...
function Home() {
  ...
  return (
    <div>
      ...
      <div>
        <a href="#"><img src="/home_1.jpg" alt="/home_1.jpg" /></a>
        <a href="#"><img src="/home_2.jpg" alt="/home_2.jpg" /></a>
        <a href="#"><img src="/home_3.jpg" alt="/home_3.jpg" /></a>
        <a href="#"><img src="/home_4.jpg" alt="/home_4.jpg" /></a>
